...
const skills:Skill[] = [
  ...
  { name: "Linux", icon: FaLinux, color: "#ffff" },
];
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
          {skills.map((skill) => (
            <div
              key={skill.name}
              className="group flex flex-col items-center p-6 bg-card/10 backdrop-blur-lg border border-border rounded-2xl hover:shadow-2xl hover:border-primary/40 hover:shadow-primary/10 hover:scale-105 transition-all duration-300"
              style={
                {
            ...
            >
              ...
              <div className="relative mb-4">
                <skill.icon className="text-4xl text-gray-400 transition-all duration-300 group-hover:scale-110 group-hover:[color:var(--skill-color)]" />
              </div>
