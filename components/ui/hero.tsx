    ...
    <section className="relative flex items-center justify-center px-4 overflow-hidden mt-36">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <div className="flex  sm:flex-row gap-4 justify-center items-center mb-16">
          <button className="group relative px-8 py-4 bg-primary text-primary-foreground rounded-2xl font-semibold transition-all hover:shadow-2xl hover:shadow-primary/40 hover:scale-105">
            <div className="absolute inset-0 bg-gradient-to-r from-primary to-foreground rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity -z-10" />
            Contact Me
          </button>

          <button className="group px-3 sm:px-8 py-4 border-2 border-primary text-foreground rounded-2xl font-semibold transition-all hover:bg-primary/10 hover:scale-105">
            Download Resume
          </button>
        </div>
      </div>
